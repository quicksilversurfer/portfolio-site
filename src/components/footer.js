...
<div className={footerStyles.footerWrapper}>
  <ul className={footerStyles.list}>
    ...
    <li className={footerStyles.listItem}><a href="/static/Resume_Prateek_Solanki-afdfbdbe79aeb92113b234f1a4dfd4d1.pdf" target="_blank" rel="noopener noreferrer" >Resume</a></li>
